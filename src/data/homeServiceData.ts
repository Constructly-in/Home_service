const homeServiceData = [
  {
    ...
    imagelink_square: require('../assets/home_service_assets/square/plumber.png'),
    imagelink_portrait: require('../assets/home_service_assets/portrait/plumberp.png'),
    // ingredients: 'Milk',
 ...
 Works with a variety of electrical components such as switches, outlets, circuit breakers, and lighting fixtures Diagnoses and resolves electrical issues such as power outages, faulty wiring, and malfunctioning appliances Ensures the safe and efficient operation of electrical systems in residential, commercial, and industrial buildings`,
    // roasted: 'Medium Roasted',
    imagelink_square: require('../assets/home_service_assets/square/electrician.png'),
    imagelink_portrait: require('../assets/home_service_assets/portrait/electricianp.png'),
    // ingredients: 'Milk',
  ...
  },
  {
    ...
    // roasted: 'Medium Roasted',
    imagelink_square: require('../assets/home_service_assets/square/painter.png'),
    imagelink_portrait: require('../assets/home_service_assets/portrait/painterp.png'),
    // ingredients: 'Milk',
  ...
  },
  {
    ...
    // roasted: 'Medium Roasted',
    imagelink_square: require('../assets/home_service_assets/square/carpainter.png'),
    imagelink_portrait: require('../assets/home_service_assets/portrait/carpenterp.png'),
    // ingredients: 'Milk',
  ...
  },
  {
    ...
    // roasted: 'Medium Roasted',
    imagelink_square: require('../assets/home_service_assets/square/cleaner.png'),
    imagelink_portrait: require('../assets/home_service_assets/portrait/cleanerp.png'),
    // ingredients: 'Milk',
